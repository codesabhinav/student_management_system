...
$result = mysqli_query($conn,"SELECT * FROM batch_details");
?>
...
<section class="main_content dashboard_part large_header_bg">
   ...
   <?php include 'navbar.php'?>
    ...
    <td><a href="ps_batch_update.php?id=<?php echo $row["id"]; ?>"><input type="submit" value="Update" class="btn-info" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a>

    <a href="ps_batch_delete.php?id=<?php echo $row["id"]; ?>"><input type="submit" class="btn-danger" value="Delete" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a></td>
    </tr>
    <?php
    $i++;
    }
...
<div id="back-top" style="display: none;">
  ...
  <form action="ps_batch_insert.php" method="post">
                    ...
                    ?>
                                       ...
                                       <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="time" class="form-control" id="inputBatchTime"  name="batch_time">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id ="inputFaculty"  class="form-control" name="faculty" required>
                    ...
                    ?>
                                       ...
                                       <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id ="inputModuleName"  class="form-control" name="module_name" required>
                                                <option selected>Select...</option>
