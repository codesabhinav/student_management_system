...
<section class="main_content dashboard_part large_header_bg">
   ...
   <?php include 'navbar.php'?>
                                    ...
                                    <table class="table lms_table_active3 ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Short Term Course</th>
    ...
    <td><?php echo $row["short_term_course"]; ?></td>
    <td><?php echo $row["core_project_course"]; ?></td>
    <td><a href="#" class="status_btn">Active</a></td>

    <td><a href="ps_course_update.php?id=<?php echo $row["id"]; ?>"><input type="submit" value="Update" class="btn-info" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a>

    <a href="ps_course_delete.php?id=<?php echo $row["id"]; ?>"><input type="submit" class="btn-danger" value="Delete" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a></td>
    </tr>
    <?php
    $i++;
    }
...
<div id="back-top" style="display: none;">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-4">
        <form action="ps_course_insert.php" method="post">
                    ...
                    <option value="Diploma Track- Java, Advanced Java, Andorid">Diploma Track- Java, Advanced Java, Andorid</option>
                                       ...
                                       <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="inputSoftSkillCourse" class="form-control" name="short_term_course">
                                                <option selected>Select...</option>
