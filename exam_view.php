...
$result = mysqli_query($conn,"SELECT * FROM exam_details");
?>
...
<section class="main_content dashboard_part large_header_bg">
   ...
   <?php include 'navbar.php'?>
                                    ...
                                    <table class="table lms_table_active3 ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Questions Paper</th>
    ...
    <td><?php echo $row["marks_per_questions"]; ?></td>

    


    <td><a href="questions_form.php?id=<?php echo $row["id"]; ?>"><input type="submit" value="View" class="btn-info" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a></td>
        <td><a href="#" class="status_btn">Active</a></td>

    <td><a href="ps_exam_delete.php?id=<?php echo $row["id"]; ?>"><input type="submit" class="btn-danger" value="Delete" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a></td>
...
<div id="back-top" style="display: none;">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-4">
        ...
        <form action="ps_exam_insert.php" method="post">
                ...
                <div class="col-lg-12">
                    ...
                    <option value="Diploma Track- Java, Advanced Java, Andorid">Diploma Track- Java, Advanced Java, Andorid</option>
                                       ...
                                       <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputExamMarks">Exam Marks</label>
                                            <input type="number" class="form-control" id="inputExamMarks" name="exam_marks">
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputNoofQuestions">No of Questions</label>
                                            <input type="number" class="form-control" id="inputNoofQuestions" name="no_of_questions">
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputMarksPerQuestions">Marks Per Questions</label>
                                            <input type="number" class="form-control" id="input MarksPer Questions" name="marks_per_questions">
                                        </div>
                                    </div>
