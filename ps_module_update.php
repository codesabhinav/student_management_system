...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE module_details set id='" . $_POST['id'] . "',
	module_name='" . $_POST['module_name'] . "',
	core_project_course='" . $_POST['core_project_course'] . "'
	WHERE id='" . $_POST['id'] . "'");
header('Location:module_view.php');
}
$result = mysqli_query($conn,"SELECT * FROM module_details WHERE id='" . $_GET['id'] . "'");
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputModuleName" placeholder="Module Name" name="module_name" value="<?php echo $row['module_name']; ?>">
                                        </div>
                                    </div>
