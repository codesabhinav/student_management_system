...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE user_details set id='" . $_POST['id'] . "',
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputUserName" name="user_name" value="<?php echo $row['user_name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputFullName" name="full_name" value="<?php echo $row['full_name']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputUserType" name="user_type"value="<?php echo $row['user_type']; ?>">
                                        </div>
                                    </div>
