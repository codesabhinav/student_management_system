...
<section class="main_content dashboard_part large_header_bg">
   ...
   <?php include 'navbar.php'?>
    ...
    <td><a href="ps_user_update.php?id=<?php echo $row["id"]; ?>"><input type="submit" value="Update" class="btn-info" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a>

    <a href="ps_user_delete.php?id=<?php echo $row["id"]; ?>"><input type="submit" class="btn-danger" value="Delete" style="border-radius: 5px;padding-left: 10px;padding-right: 10px;"></a></td>
    </tr>
    <?php
    $i++;
    }
...
<div id="back-top" style="display: none;">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content p-4">
        <form action="ps_user_insert.php" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputUserType" name="user_type">
                                        </div>
                                    </div>
